...
public class TowerBuilld : MonoBehaviour
{
    [SerializeField] private int _levelCount;
    [SerializeField] private GameObject _beam;

    [SerializeField] private float _additionalScale;
    [SerializeField] private GameObject _spawnPlatform;
    ...
    public float BeamScaleY => _levelCount / 2f + _startAndFinishAditionalScale + _additionalScale / 2f;
    ...
    private void SpawnPlatform(GameObject platform, ref Vector3 spawnPosition, Transform parent)
    {
